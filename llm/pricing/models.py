...
class CostsConfig(BaseModel):
    ...
    pricing: Dict[str, ModelPricingConfig] = Field(
        default={
            ...
            "anthropic/claude-opus-4-5": ModelPricingConfig(input=15.00, output=75.00),
            "anthropic/claude-sonnet-4-5": ModelPricingConfig(input=3.00, output=15.00),
            "anthropic/claude-haiku-4-5": ModelPricingConfig(input=0.80, output=4.00),
            "anthropic/claude-3-5-sonnet-20241022": ModelPricingConfig(input=3.00, output=15.00),
            "anthropic/claude-3-5-haiku-20241022": ModelPricingConfig(input=0.80, output=4.00),
            "anthropic/claude-3-opus-20240229": ModelPricingConfig(input=15.00, output=75.00),
            "anthropic/claude-3-haiku-20240307": ModelPricingConfig(input=0.25, output=1.25),

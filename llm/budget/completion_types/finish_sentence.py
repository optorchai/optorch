...
class FinishSentence(BaseCompletionType):
    ...
    def should_yield(self, chunk: str, buffer: str) -> Tuple[bool, str]:
        ...
        if any(new_buffer.rstrip().endswith(end) for end in self.SENTENCE_ENDINGS):
            return True, ""
